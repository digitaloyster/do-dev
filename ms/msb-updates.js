...
document.addEventListener("nextStep", function()  { nextStep();  });
document.addEventListener("prevStep", function()  { prevStep(); });
document.addEventListener("gotoStep", function(e) { gotoStep(e.detail); });

document.addEventListener("enableSubmit", function(e) {
  $('#'+settings.submitButton).find('span').html(e.detail);
  addSubmit();
});
document.addEventListener("disableSubmit", function(e) {
  $('#'+settings.submitButton).find('span').html(e.detail);
